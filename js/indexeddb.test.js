...
window.onload = function() {
  ...
  function displayData() {
    ...
    var t0=performance.now(),cursor=event.target.result;cursor&&(document.getElementById("view").innerHTML="Name: "+cursor.value.name+"<br>Color: "+cursor.value.color+"<br>Animal: "+cursor.value.animal+"<br>Text: "+cursor.value.text,cursor.continue());var t1=performance.now();
    var time = t1 - t0;
